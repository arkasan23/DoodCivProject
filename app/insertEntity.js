...
let table_data = {
    "units_data": [
        ["scout", 50, 0, 3, 0, 50],
        ["warrior", 100, 35, 1, 1, 75],
        ["swordsman", 150, 75, 1, 1, 125],
        ["knight", 200, 125, 1, 1, 175],
        ["slinger", 75, 50, 1, 3, 100],
        ["archer", 100, 75, 1, 5, 125],
        ["musketeer", 125, 100, 1, 6, 170],
        ["horseman", 175, 75, 4, 1, 175],
        ["lancer", 250, 100, 6, 2, 225],
        ["chariot", 350, 50, 8, 1, 275]
...
async function insert_data() {
    try {
        ...
        let unit_command = "INSERT INTO units_data(name, health, damage, move_range, attack_range, cost) VALUES($1, $2, $3, $4, $5, $6)";
        let struct_command = "INSERT INTO structures_data(name, health, cost) VALUES($1, $2, $3)";


        for (const data of table_data.units_data) {
            await pool.query(unit_command, [data[0], data[1], data[2], data[3], data[4], data[5]]);
        }
